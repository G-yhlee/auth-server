...
export async function testOAuthLogin() {
  ...
  console.log("- Google: /api/auth/sign-in/social/google");
  console.log("- GitHub: /api/auth/sign-in/social/github");
  
  console.log("\nCallback URLs (configure in OAuth providers):");
  console.log("- Google: http://localhost:3333/api/auth/callback/google");
  console.log("- GitHub: http://localhost:3333/api/auth/callback/github");
